    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher, CommandRegistryAccess registryAccess, CommandManager.RegistrationEnvironment environment) {
        dispatcher.register(CommandManager.literal("shulker")
                .then(CommandManager.literal("set")
                        .requires(source -> {
                            if (Config.REQUIRE_PERMISSION_FOR_COMMAND) {
                                return Permissions.check(source, "bettershulkers.command.set", 2);
                            }
                            return true;
                        })
                ...
                .then(CommandManager.literal("info")
                        .requires(source -> {
                            if (Config.REQUIRE_PERMISSION_FOR_COMMAND) {
                                return Permissions.check(source, "bettershulkers.command.info", 2);
                            }
                            return true;
                        })
                ...
                .then(CommandManager.literal("reload")
                        .requires(source -> {
                            if (Config.REQUIRE_PERMISSION_FOR_COMMAND) {
                                return Permissions.check(source, "bettershulkers.command.reload", 2);
                            }
                            return true;
                        })
