...
/**
 * Holds all information for the Material Collector enchantment
 */
public final class MaterialCollector {
    /**
     * ID for the Material Collector enchantment
     */
    ...
    /**
     * Initializes the Material Collector class
     */
    ...
    /**
     * If the ItemStack has the Material Collector enchantment
     * @param itemStack ItemStack to check
     * @param level A world instance
     * @return If the ItemStack has the Material Collector enchantment
     */
